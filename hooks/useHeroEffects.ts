 ...
 * NOTE: Mouse parallax is disabled on mobile devices in favor of device motion tilt effects.
 */
export const useHeroEffects = () => {
  ...
  useEffect(() => {
    ...
    // Handle touch devices (legacy support for non-mobile touch devices)
