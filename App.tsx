    ...
    <div className="bg-base-100 text-base-content antialiased">
      ...
      <main className="pt-[5.5rem]"> {/* Add padding-top to offset fixed navbar */}
        <Hero 
            ...
            profileImageUrl="" // Commented out hero image
        />
        <About 
            id="about" 
      ...
      {showScrollTop && (
        <button
          onClick={scrollTop}
                      className="fixed bottom-8 right-8 p-3 bg-primary text-white rounded-full shadow-lg hover:bg-sky-700 z-50 animate-fade-in-up hover-lift hover-glow"
